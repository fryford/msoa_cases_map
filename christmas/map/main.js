	...
	function onMove(e) {
		...
		if (newareacd != oldareacd) {
			...
			if (features.length != 0) {
				setAxisVal(e.features[0].properties.areanm, e.features[0].properties.areanmhc, e.features[0].properties.areacd, e.features[0].properties.date);
			}
		}
	}
	...
	function successpc(lat,lng) {
		...
		var tilechecker = setInterval(function(){
			 ...
			 if(features.length != 0){
				...
				disableMouseEvents();
				setAxisVal(features[0].properties.areanm, features[0].properties.areanmhc, features[0].properties.areacd, features[0].properties.date);
